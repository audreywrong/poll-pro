    ...
    <div class="w-full">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6">
                ...
                <input v-model="question" placeholder="Who is your favorite artist?"
            ...
            <div class="flex flex-wrap mb-6">
                ...
                <div v-for="(option, index) in options"
                    ...
                    <input v-model="option.value" :placeholder="option.placeholder"
                ...
                <div class="w-full flex items-center border-b border-b-2 border-teal-500 py-2">
                    <input @keyup.enter="addNewOption" v-model="newOption"
                        class="appearance-none bg-transparent border-none block w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                        type="text" placeholder="Prince" aria-label="Full name">
           ...
           el: '#app',
            ...
            data(){
               return {
                    ...
                    question: '',
                    options: [
                        { value: '', placeholder: 'Freddie Mercury'},
                        { value: '', placeholder: 'Dave Grohl'},
                    ],
                   error_message: '',
               }
            },
